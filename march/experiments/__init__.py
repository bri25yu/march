...
def get_experiments_from_module(module: ModuleType) -> Dict[str, Type[ExperimentBase]]:
    ...
    for attr_name in dir(module):
        ...
        if not issubclass(value, ExperimentBase):
            continue
...
def recursively_discover_experiments(
    ...
    2. Is a subclass of `march.experiments.base.ExperimentBase`
...
available_experiments = recursively_discover_experiments(current_module)
