...
class DOBaselineExperiment(BaselineExperiment):
    ...
    def get_data_collator(self, tokenizer: PreTrainedTokenizerFast):
        ...
        def data_collator(examples):
            ...
            attention_mask = (
                examples["attention_mask"][:, None, :] | causal_mask_input[None, :, :]
            )
